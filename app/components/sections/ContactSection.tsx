            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-4 max-w-xl mx-auto">
              ...
              <a 
                ...
                className={`w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl font-mono text-base md:text-lg font-black tracking-wide transition-all duration-150 transform active:translate-y-1.5 ${
                  isDark 
                    ? "bg-gradient-to-b from-cyan-400 to-cyan-500 text-slate-950 border border-cyan-300/50 shadow-[0_6px_0_0_#0891b2,0_10px_18px_rgba(6,182,212,0.35)] hover:bg-cyan-300 hover:shadow-[0_4px_0_0_#0891b2,0_6px_12px_rgba(6,182,212,0.3)] hover:translate-y-0.5 active:shadow-[0_1px_0_0_#0891b2]" 
                    : "bg-gradient-to-b from-cyan-500 to-blue-600 text-white border border-cyan-400 shadow-[0_6px_0_0_#1d4ed8,0_10px_18px_rgba(29,78,216,0.3)] hover:from-cyan-400 hover:to-blue-500 hover:shadow-[0_4px_0_0_#1d4ed8,0_6px_12px_rgba(29,78,216,0.25)] hover:translate-y-0.5 active:shadow-[0_1px_0_0_#1d4ed8]"
                }`}
              >
              ...
              <a 
                ...
                className={`w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl font-mono text-base md:text-lg font-black tracking-wide transition-all duration-150 transform active:translate-y-1.5 ${
                  isDark 
                    ? "bg-gradient-to-b from-emerald-400 to-emerald-500 text-slate-950 border border-emerald-300/50 shadow-[0_6px_0_0_#047857,0_10px_18px_rgba(16,185,129,0.35)] hover:bg-emerald-300 hover:shadow-[0_4px_0_0_#047857,0_6px_12px_rgba(16,185,129,0.3)] hover:translate-y-0.5 active:shadow-[0_1px_0_0_#047857]" 
                    : "bg-gradient-to-b from-emerald-500 to-green-600 text-white border border-emerald-400 shadow-[0_6px_0_0_#15803d,0_10px_18px_rgba(21,128,61,0.3)] hover:from-emerald-400 hover:to-green-500 hover:shadow-[0_4px_0_0_#15803d,0_6px_12px_rgba(21,128,61,0.25)] hover:translate-y-0.5 active:shadow-[0_1px_0_0_#15803d]"
                }`}
              >
